...
Experienced and versatile software and DevOps engineer with over a decade of expertise in the industry. Recognized for proficiency in backend development with a focus on Golang, gRPC, and Protocol Buffers, alongside extensive experience in microservices architecture. Adept in database technologies, including PostgreSQL and MongoDB. Possesses robust DevOps skills, showcasing expertise in Linux, automation, optimization, and CI/CD practices. Proven track record of designing, implementing, and maintaining scalable, high-performance systems. Excels in fostering collaboration across teams to achieve optimal results in dynamic and challenging environments.
